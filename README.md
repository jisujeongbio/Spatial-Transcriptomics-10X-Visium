...
- 03_CARD_deconvolution.R: Region-matched deconvolution analysis using [CARD](https://github.com/YMa-lab/CARD) (Ma and Zhou, *Nature Biotechnology*, 2022) with multiple [WMB-10X reference datasets](https://allen-brain-cell-atlas.s3.us-west-2.amazonaws.com/index.html#expression_matrices/WMB-10Xv3/20230630/) from Allen Brain Atlas.
